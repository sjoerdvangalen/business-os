...
async function main() {
  ...
  // Spot-check records that had issues in the 200-record run
  const targets = [
    { company: "Elastic", persona: "ops" as Persona },
    { company: "Caris Life Sciences", persona: "tech" as Persona },
    { company: "GM Financial", persona: "tech" as Persona },
    { company: "Q2", persona: "csuite" as Persona },
    { company: "Bio-Rad Laboratories", persona: "csuite" as Persona },
    { company: "EVERSANA", persona: "csuite" as Persona },
  ];
