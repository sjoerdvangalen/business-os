...
const navigation: NavItem[] = [
  ...
  { name: 'Execution', href: '/execution', icon: PlayIcon },
  { name: 'Campaigns', href: '/campaigns', icon: MegaphoneIcon },
  { name: 'Strategies', href: '/strategies', icon: LightBulbIcon },
  {
    name: 'CRM',
    href: '/crm',
    icon: Building2Icon,
    children: [
      ...
      { name: 'Opportunities', href: '/crm/opportunities', icon: FunnelIcon },
      { name: 'Leads', href: '/crm/leads', icon: TargetIcon },
      { name: 'Meetings', href: '/crm/meetings', icon: CalendarIcon },
    ],
  },
  { name: 'Alerts', href: '/alerts', icon: BellIcon },
  { name: 'Infrastructure', href: '/infrastructure', icon: ServerIcon },
  { name: 'Tenants', href: '/tenants', icon: BuildingIcon },
